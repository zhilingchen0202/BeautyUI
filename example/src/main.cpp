...
#ifdef BeautyUI_BUILD_STATIC_LIB
#  if (QT_VERSION > QT_VERSION_CHECK(6, 2, 0))
Q_IMPORT_QML_PLUGIN(BeautyUIPlugin)
#  endif
#  include <BeautyUI.h>
#endif
...
#endif
    QApplication::setOrganizationName("beautyui");
    QApplication::setOrganizationDomain("beautyui");
    QApplication::setApplicationName("BeautyUI");
    QApplication::setApplicationDisplayName("BeautyUI Example");
...
#ifdef BeautyUI_BUILD_STATIC_LIB
    BeautyUI::getInstance()->registerTypes(&engine);
#endif

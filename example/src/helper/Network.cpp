...
BDownloadParam::BDownloadParam(QObject *parent) : QObject{parent} {
}

BDownloadParam::BDownloadParam(QString destPath, bool append, QObject *parent)
    : QObject{parent} {
...
NetworkParams *NetworkParams::toDownload(QString destPath, bool append) {
    _downloadParam = new BDownloadParam(std::move(destPath), append, this);
    return this;
}

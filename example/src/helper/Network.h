...
/**
 * @brief The BDownloadParam class
 */
class BDownloadParam : public QObject {
    Q_OBJECT
public:
    explicit BDownloadParam(QObject *parent = nullptr);

    BDownloadParam(QString destPath, bool append, QObject *parent = nullptr);
...
public:
    BDownloadParam *_downloadParam = nullptr;

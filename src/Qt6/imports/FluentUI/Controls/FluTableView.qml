...
Rectangle {
    ...
    property var sourceModel:BTableModel {
        columnSource: control.columnSource
    }
    property var columnSource: []
    property var dataSource
    property color borderColor: BTheme.dark ? Qt.rgba(37/255,37/255,37/255,1) : Qt.rgba(228/255,228/255,228/255,1)
    property bool horizonalHeaderVisible: true
    property bool verticalHeaderVisible: true
    property color selectedBorderColor: BTheme.primaryColor
    property color selectedColor: BTools.withOpacity(BTheme.primaryColor,0.3)
    ...
    Component{
        ...
        Item{
            ...
            Flickable{
                ...
                TextArea.flickable: BMultilineTextBox {
                    id:text_box
                    text: String(display)
                    readOnly: true === control.columnSource[column].readOnly
            ...
            BIconButton{
                iconSource:BentIcons.ChromeClose
                iconSize: 10
                width: 20
                height: 20
                padding: 0
            ...
            Rectangle{
                ...
                color:{
                    ...
                    if(d.rowHoverIndex === row || item_table_mouse.isRowSelected){
                        return BTheme.dark ? Qt.rgba(1,1,1,0.06) : Qt.rgba(0,0,0,0.06)
                    }
                    return (row%2!==0) ? control.color : (BTheme.dark ? Qt.rgba(1,1,1,0.03) : Qt.rgba(0,0,0,0.03))
                }
                MouseArea{
                    anchors.fill: parent
    ...
    Component{
        ...
        Rectangle{
            ...
            color: BTheme.dark ? Qt.rgba(50/255,50/255,50/255,1) : Qt.rgba(247/255,247/255,247/255,1)
            Rectangle{
            ...
            MouseArea{
                ...
                onPressed :
                    (mouse)=>{
                        BTools.setOverrideCursor(Qt.SplitHCursor)
    ...
    Component{
        ...
        Rectangle{
            ...
            MouseArea{
                ...
                onPressed :
                    (mouse)=>{
                        BTools.setOverrideCursor(Qt.SplitVCursor)
                        clickPos = Qt.point(mouse.x, mouse.y)
                    }
                onReleased:{
                    BTools.restoreOverrideCursor()
    ...
    Item{
        ...
        Component{
            ...
            Rectangle{
                ...
                color: {
                    if(Window.active){
                        return BTheme.dark ? Qt.rgba(48/255,48/255,48/255,1) :Qt.rgba(1,1,1,1)
                    }
                    return BTheme.dark ? Qt.rgba(56/255,56/255,56/255,1) :Qt.rgba(243/255,243/255,243/255,1)
                }
                visible: table_view.rows !== 0
                Rectangle{
                    z:99
                    anchors.fill: parent
                    border.color: BTheme.dark ? Qt.rgba(26/255,26/255,26/255,0.6) : Qt.rgba(191/255,191/255,191/255,0.3)
                    BShadow{
                        radius: 0
                        anchors.fill: parent
                    }

            ...
            Column{
                ...
                move: Transition {
                    NumberAnimation {
                        ...
                        duration: BTheme.animationEnabled ? 333 : 0
                    }
                }
        ...
        Component{
            ...
            Item{
                ...
                BLoader{
                    ...
                    sourceComponent:itemcomponent ? itemcomponent : mcontrol.Bent_sytle
                }
            }
        }
        property Component Bent_sytle:  Rectangle{
            ...
            Row{
                ...
                BIcon{
                    iconSource:{
                        switch(_super.type){
                        case mcontrol.const_success: return BentIcons.CompletedSolid
                        case mcontrol.const_warning: return BentIcons.InfoSolid
                        case mcontrol.const_info:    return BentIcons.InfoSolid
                        case mcontrol.const_error:   return BentIcons.StatusErrorFull
                        }BentIcons.StatusErrorFull
                        return BentIcons.FA_info_circle
                    }
                    iconSize:20
                    iconColor: {
                        if(BTheme.dark){
                            ...
                            case mcontrol.const_info:    return BTheme.primaryColor

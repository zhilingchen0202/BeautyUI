...
Rectangle{
    ...
    RowLayout{
        ...
        BIconButton{
            ...
            horizontalPadding: 0
            rightPadding: 2
            iconSource: BTheme.dark ? BentIcons.Brightness : BentIcons.QuietHours
        ...
        BIconButton{
            ...
            verticalPadding: 0
            horizontalPadding: 0
            iconSource : BentIcons.ChromeMinimize
            Layout.alignment: Qt.AlignVCenter
            iconSize: 11
            text:minimizeText
            radius: 0
        ...
        BIconButton{
            ...
            verticalPadding: 0
            horizontalPadding: 0
            iconSource : d.isRestore  ? BentIcons.ChromeRestore : BentIcons.ChromeMaximize
            color: {
                if(down){

...
Item {
    property int tabWidthBehavior : BTabViewType.Equal
    property int closeButtonVisibility : BTabViewType.Always
        ...
        delegate:  Item{
            ...
            Item{
                ...
                Item{
                    ...
                    width: {
                        if(tabWidthBehavior === BTabViewType.Equal){
                            return Math.max(Math.min(d.maxEqualWidth,tab_nav.width/tab_nav.count),41 + item_btn_close.width)
                        }
                        if(tabWidthBehavior === BTabViewType.SizeToContent){
                            return itemWidth
                        }
                        if(tabWidthBehavior === BTabViewType.Compact){
                    ...
                    BIconButton{
                        ...
                        height: 24
                        visible: {
                            if(closeButtonVisibility === BTabViewType.Never)
                                return false
                            if(closeButtonVisibility === BTabViewType.OnHover)

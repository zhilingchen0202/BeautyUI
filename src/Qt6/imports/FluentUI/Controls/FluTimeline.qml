...
Item{
    property int mode: BTimelineType.Left
    property alias model: repeater.model
    property color lineColor: BTheme.dark ? Qt.rgba(80/255,80/255,80/255,1) : Qt.rgba(210/255,210/255,210/255,1)
    id:control
    implicitWidth: 380
    implicitHeight: layout_column.height
    QtObject{
        id:d
        property bool isLeft: control.mode === BTimelineType.Left
        property bool isRight: control.mode === BTimelineType.Right
        property bool isAlternate: control.mode === BTimelineType.Alternate

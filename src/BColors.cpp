...
BColors::BColors(QObject *parent) : QObject{parent} {
    ...
    auto yellow = new BAccentColor(this);
    ...
    auto orange = new BAccentColor(this);
    ...
    auto red = new BAccentColor(this);
    ...
    auto magenta = new BAccentColor(this);
    ...
    auto purple = new BAccentColor(this);
    ...
    auto blue = new BAccentColor(this);
    ...
    auto teal = new BAccentColor(this);
    ...
    auto green = new BAccentColor(this);
...
[[maybe_unused]] BAccentColor *BColors::createAccentColor(const QColor &primaryColor) {
    auto accentColor = new BAccentColor(this);
    accentColor->normal(primaryColor);
    accentColor->dark(BTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->light(BTools::getInstance()->withOpacity(primaryColor, 0.9));
    accentColor->darker(BTools::getInstance()->withOpacity(accentColor->dark(), 0.8));
    accentColor->lighter(BTools::getInstance()->withOpacity(accentColor->light(), 0.8));
    accentColor->darkest(BTools::getInstance()->withOpacity(accentColor->darker(), 0.7));
    accentColor->lightest(BTools::getInstance()->withOpacity(accentColor->lighter(), 0.7));
    return accentColor;
}

...
class BTableSortProxyModel : public QSortFilterProxyModel {
    Q_OBJECT
    Q_PROPERTY_AUTO_P(QVariant, model)
    QML_NAMED_ELEMENT(BTableSortProxyModel)
public:
    explicit BTableSortProxyModel(QSortFilterProxyModel *parent = nullptr);

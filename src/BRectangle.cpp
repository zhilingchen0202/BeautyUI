...
BRectangle::BRectangle(QQuickItem *parent) : QQuickPaintedItem(parent) {
    color(QColor(255, 255, 255, 255));
    radius({0, 0, 0, 0});
    connect(this, &BRectangle::colorChanged, this, [=] { update(); });
    connect(this, &BRectangle::radiusChanged, this, [=] { update(); });
}


void BRectangle::paint(QPainter *painter) {
    painter->save();

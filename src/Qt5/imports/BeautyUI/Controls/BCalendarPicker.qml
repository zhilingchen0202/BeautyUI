...
BButton {
    text: {
        if(control.current){
            return control.current.toLocaleDateString(BApp.locale,"yyyy/M/d")
        }
    ...
    BIcon{
        iconSource: BeautyIcons.Calendar
        iconSize: 14
                    ...
                    RowLayout{
                        ...
                        Item{
                            ...
                            BTextButton{
                                ...
                                contentItem: BText {
                                    text: d.displayDate.toLocaleString(BApp.locale, "MMMM yyyy")
                            ...
                            BTextButton{
                                ...
                                anchors.centerIn: parent
                                contentItem: BText {
                                    text: d.displayDate.toLocaleString(BApp.locale, "yyyy")
                                    verticalAlignment: Text.AlignVCenter
                                }
                            ...
                            BTextButton{
                                ...
                                contentItem: BText {
                                    ...
                                    verticalAlignment: Text.AlignVCenter
                                    textColor: BTheme.fontTertiaryColor
                                }
                        ...
                        BIconButton{
                            id:icon_up
                            iconSource: BeautyIcons.CaretUpSolid8
                            iconSize: 10
                            onClicked: {
                                d.previousButton()
                            }
                        ...
                        BIconButton{
                            id:icon_down
                            iconSource: BeautyIcons.CaretDownSolid8
                            iconSize: 10
                                ...
                                BControl{
                                        ...
                                        color: {
                                            if(toYear){
                                                if(control_delegate.pressed){
                                                    return BTheme.dark ? Qt.darker(BTheme.primaryColor,1.2) : Qt.lighter(BTheme.primaryColor,1.2)
                                                }
                                                if(control_delegate.hovered){
                                                    return BTheme.dark ? Qt.darker(BTheme.primaryColor,1.1) : Qt.lighter(BTheme.primaryColor,1.1)
                                                }
                                    ...
                                    BText{
                                        ...
                                        color: {
                                            ...
                                            if(control_delegate.pressed){
                                                return BTheme.dark ? BColors.Grey100 : BColors.Grey100
                                            }
                                            if(control_delegate.hovered){
                                ...
                                GridView{
                                    ...
                                    delegate: Item{
                                        ...
                                        BControl{
                                            ...
                                            BText{
                                                text: new Date(layout_congrol.year,month).toLocaleString(BApp.locale, "MMMM")
                                                anchors.centerIn: parent
                                                opacity: {
                                ...
                                delegate: MonthGrid {
                                    ...
                                    delegate: BControl {
                                        ...
                                        Rectangle{
                                            ...
                                            anchors.centerIn: parent
                                            radius: width/2
                                            border.color: BTheme.primaryColor

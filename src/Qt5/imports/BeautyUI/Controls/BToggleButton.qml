...
Button {
    ...
    property color disableColor: {
        if(checked){
            ...
            return BTheme.dark ? Qt.rgba(59/255,59/255,59/255,1) : Qt.rgba(251/255,251/255,251/255,1)
        }
    }
    ...
    background: BControlBackground{
        ...
        border.color: {
            if(checked){
                ...
                return BTheme.dark ? Qt.rgba(48/255,48/255,48/255,1) : Qt.rgba(188/255,188/255,188/255,1)
            }
        }
    }
    contentItem: BText {

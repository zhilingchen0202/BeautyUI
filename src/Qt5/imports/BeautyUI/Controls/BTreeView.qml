...
Rectangle {
    ...
    property color lineColor: BTheme.dividerColor
                ...
                Component{
                    ...
                    BIconButton{
                        ...
                        contentItem:BIcon{
                            ...
                            iconSource:BeautyIcons.ChevronDown
                            iconSize: 16
        ...
        delegate: MouseArea{
            ...
            Rectangle{
                ...
                color:{
                    ...
                    return (row%2!==0) ? control.color : (BTheme.dark ? Qt.rgba(1,1,1,0.015) : Qt.rgba(0,0,0,0.015))
                }
                Item{
                    anchors.fill: parent

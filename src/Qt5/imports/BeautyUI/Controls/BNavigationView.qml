...
Item {
    ...
    property BObject items
    property BObject footerItems
    property int displayMode: BNavigationViewType.Auto
    property Component autoSuggestBox
    property Component actionItem
    property int topPadding: 0
    property int pageMode: BNavigationViewType.Stack
    property BMenu navItemRightMenu
    property BMenu navItemExpanderRightMenu
    ...
    Item{
        ...
        property bool isCompact: d.displayMode === BNavigationViewType.Compact
        property bool isMinimal: d.displayMode === BNavigationViewType.Minimal
        property bool isCompactAndPanel: d.displayMode === BNavigationViewType.Compact && d.enableNavigationPanel
        property bool isCompactAndNotPanel:d.displayMode === BNavigationViewType.Compact && !d.enableNavigationPanel
        property bool isMinimalAndPanel: d.displayMode === BNavigationViewType.Minimal && d.enableNavigationPanel
        property color itemDisableColor: BTheme.dark ? Qt.rgba(131/255,131/255,131/255,1) : Qt.rgba(160/255,160/255,160/255,1)
        ...
        function handleItems(){
            var _idx = 0
            var data = []
            var comEmpty = Qt.createComponent("BPaneItemEmpty.qml");
            if(items){
                for(var i=0;i<items.children.length;i++){
                    ...
                    data.push(item)
                    _idx++
                    if(item instanceof BPaneItemExpander){
    ...
    Component.onCompleted: {
        d.displayMode = Qt.binding(function(){
            if(control.displayMode !==BNavigationViewType.Auto){
                return control.displayMode
            }
            if(control.width<=700){
                return BNavigationViewType.Minimal
            }else if(control.width<=900){
                return BNavigationViewType.Compact
            }else{
                return BNavigationViewType.Open
            }
        })
    ...
    Connections{
        ...
        function onDisplayModeChanged(){
            if(d.displayMode === BNavigationViewType.Compact){
                collapseAll()
            }
    ...
    Component{
        ...
        Item{
            ...
            Behavior on height {
                enabled: BTheme.animationEnabled && d.animDisabled
                NumberAnimation{
                    duration: 83
                }
            }
            ...
            BControl{
                ...
                Rectangle{
                    ...
                    BIcon{
                        ...
                        iconSource:BeautyIcons.ChevronUp
                        iconSize: 15
                        anchors{
                            verticalCenter: parent.verticalCenter
                            right: parent.right
                        ...
                        color: {
                            ...
                            return BTheme.dark ? "#FFFFFF" : "#000000"
                        }
                    }
                    color: {
                        if(!item_control.enabled){
        ...
        RowLayout{
            ...
            BIconButton{
                ...
                onClicked: {
                    ...
                    if(pageMode === BNavigationViewType.Stack){
                        var nav_stack = loader_content.item.navStack()
                        var nav_stack2 = loader_content.item.navStack2()
                        nav_stack.pop()
                        if(nav_stack.currentItem.launchMode === BPageType.SingleInstance){
                    ...
                    }else if(pageMode === BNavigationViewType.NoStack){
            ...
            BIconButton{
                id:btn_menu
                iconSource: BeautyIcons.GlobalNavButton
                iconSize: 15
        ...
        Item{
            ...
            StackLayout{
                ...
                visible: {
                    ...
                    return BPageType.SingleInstance === nav_stack.currentItem.launchMode
                }
            }
            function navStack(){
                return nav_stack
    ...
    Rectangle{
        ...
        border.color: BTheme.dark ? Qt.rgba(45/255,45/255,45/255,1) : Qt.rgba(226/255,230/255,234/255,1)
        border.width:  d.isMinimal || d.isCompactAndPanel ? 1 : 0
        color: {
            if(d.isMinimal || d.enableNavigationPanel){
                return BTheme.dark ? Qt.rgba(61/255,61/255,61/255,1) : Qt.rgba(243/255,243/255,243/255,1)
            }
            return "transparent"
        }
        BShadow{
        ...
        visible: {
            if(d.displayMode !== BNavigationViewType.Minimal)
                return true
        ...
        Flickable{
            ...
            ListView{
                ...
                model:d.handleItems()
                boundsBehavior: ListView.StopAtBounds
                highlightMoveDuration: BTheme.animationEnabled && d.animDisabled ? 167 : 0
                highlight: Item{
                    clip: true
                    Rectangle{
                        height: 18
                ...
                delegate: BLoader{
                    ...
                    sourceComponent: {
                        if(model === null || !model)
                            return undefined
                        if(modelData instanceof BPaneItem){
                            return com_panel_item
                        }
                        if(modelData instanceof BPaneItemHeader){
                            return com_panel_item_header
                        }
                        if(modelData instanceof BPaneItemSeparator){
                            return com_panel_item_separatorr
                        }
                        if(modelData instanceof BPaneItemExpander){
                            return com_panel_item_expander
                        }
                        if(modelData instanceof BPaneItemEmpty){
    ...
    Component{
        id:com_placeholder
        Item{
            property int launchMode: BPageType.SingleInstance
            property string url
        }
    }
        ...
        function stackPush(){
            ...
            if(page){
                ...
                case BPageType.SingleTask:
                    ...
                    return
                case BPageType.SingleTop:
                    if (nav_stack.currentItem.url === url){
                        return
                    }
                    break
                case BPageType.Standard:
                default:
                }
            }
            var pageIndex = -1
            ...
            if(pageIndex!==-1){
                ...
                if (comp.status === Component.Ready) {
                    ...
                    if(obj.launchMode === BPageType.SingleInstance){
                        nav_stack.push(com_placeholder,options)

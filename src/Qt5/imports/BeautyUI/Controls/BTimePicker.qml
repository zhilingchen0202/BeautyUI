...
BButton {
    property int hourFormat: BTimePickerType.H
    property int isH: hourFormat === BTimePickerType.H
                        ...
                        Rectangle{
                            ...
                            color:  {
                                if(getListView().currentIndex === position){
                                    return  item_mouse.containsMouse ? Qt.darker(BTheme.primaryColor,1.1) : BTheme.primaryColor
                                }
                                if(item_mouse.containsMouse){
                                    return BTheme.dark ? Qt.rgba(63/255,60/255,61/255,1) : Qt.rgba(237/255,237/255,242/255,1)
                                }
                            ...
                            BText{
                                ...
                                color: {
                                    if(getListView().currentIndex === position){
                                        ...
                                        return BTheme.dark ? "#FFFFFF" : "#1A1A1A"
                                    }
                                }
            ...
            Rectangle{
                ...
                BFilledButton{
                    ...
                    onClicked: {
                        ...
                        if(control.hourFormat === BTimePickerType.H){
                            if (hours === "12") {

...
BIconButton {
    ...
    property BHotkey syncHotkey: undefined
    signal accepted()
    padding: 0
    verticalPadding: 0
    horizontalPadding: 0
    ...
    contentItem: Item{
        ...
        Rectangle{
            ...
            Row{
                ...
                BIcon{
                    iconSource: BeautyIcons.EditMirrored
                    iconSize: 13
                    anchors{
    ...
    BContentDialog{
        ...
        buttonFlags: BContentDialogType.NegativeButton | BContentDialogType.PositiveButton | BContentDialogType.NeutralButton

...
Item{
    ...
    Button{
        ...
        background: Rectangle{
            radius: 4
            color:BTheme.dark ? Qt.rgba(45/255,45/255,45/255,0.97) : Qt.rgba(237/255,237/255,237/255,0.97)
        }
        contentItem:BIcon{
            iconSource: vertical ? BeautyIcons.CaretUpSolid8 : BeautyIcons.CaretLeftSolid8
            width: 10
            height: 10
            iconSize: 10
            iconColor: btn_start.hovered ? BColors.Grey220  :  BColors.Grey120
    ...
    Button{
        ...
        contentItem:BIcon{
            iconSource: vertical ? BeautyIcons.CaretDownSolid8 : BeautyIcons.CaretRightSolid8
            width: 10
            height: 10
            iconSize: 10
            iconColor: btn_end.hovered ? BColors.Grey220  :  BColors.Grey120
            anchors.centerIn: parent
        }
        onClicked: {

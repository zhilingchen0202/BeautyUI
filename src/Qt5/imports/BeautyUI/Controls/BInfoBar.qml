        ...
        Component{
            ...
            Item{
                ...
                BLoader{
                    ...
                    sourceComponent:itemcomponent ? itemcomponent : mcontrol.beautySytle
                }
            }
        }
        property Component beautySytle:  Rectangle{
            ...
            Row{
                ...
                BIcon{
                    iconSource:{
                        switch(_super.type){
                        case mcontrol.const_success: return BeautyIcons.CompletedSolid
                        case mcontrol.const_warning: return BeautyIcons.InfoSolid
                        case mcontrol.const_info:    return BeautyIcons.InfoSolid
                        case mcontrol.const_error:   return BeautyIcons.StatusErrorFull
                        }BeautyIcons.StatusErrorFull
                        return BeautyIcons.FA_info_circle
                    }
                    iconSize:20
                    iconColor: {
                        if(BTheme.dark){
